...
# This version is for messing around and ruining it.
...
def seperateNameAndLetter(pathToText):
    try:
        ...
        print("Did not find an email with a text file. Ensure text message was actually sent. Messages require a couple minutes to go through.")
        BUG_OCCURED = True
        #print(str(BUG_OCCURED))
...
def main():
    ...
    #clean out inbox to avoid issues with future messages.
    clearInbox()
